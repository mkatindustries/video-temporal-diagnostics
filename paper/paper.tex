...
embeddings, and no downstream signal flags the failure. While this blindness
is well-documented for generative QA, its consequences for \emph{retrieval
embeddings} remain uncharacterized. We diagnose temporal sensitivity across six retrieval benchmarks
