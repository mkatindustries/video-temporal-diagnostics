...
\textbf{Contributions.} (1)~A \emph{temporal scramble gradient} that stress-tests temporal sensitivity and separates method classes (Figure~\ref{fig:scramble_gradient}). (2)~A \emph{feature-vs-comparator decomposition} and VLM-pipeline probes that localize where order signal dies, extending temporal-blindness diagnosis from generative QA to retrieval. (3)~A sampling-density analysis on Honda HDD tracking how the residual advantage scales with temporal dilution. (4)~Open-source code packaging the scramble gradient and reversal tests.
...
\bibitem{vjepa21} M.~Assran et al. {V-JEPA~2.1}. \emph{arXiv:2603.14482}, 2026.
...
\bibitem{videozerobench} J.~Meng et al. VideoZeroBench: Probing Video Understanding through Spatio-Temporal Evidence Verification. \emph{arXiv:2604.01569}, 2026.
