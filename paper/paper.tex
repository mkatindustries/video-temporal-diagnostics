...
No method spans copy detection and motion retrieval (Figure~\ref{fig:sensitivity_invariance}): within an encoder, matching explains 89\% of the HDD gap; pooling erases per-frame order across VLM layers. Indexable order-sensitive comparators remain open. %
\ifdefined\neuripssubmission
Code: supplementary (\texttt{REPRODUCIBILITY.md}).%
\else
