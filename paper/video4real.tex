...
On an EPIC-Kitchens manifest of $500$ sequences, a separate probe leaves three open-weight
multimodal LLMs (MLLMs) near chance: mean balanced accuracy $0.503$--$0.538$ across three direct
direction prompts. These descriptive, prompt-specific classification probes do not test
full-gallery retrieval; applying the matched-gallery protocol to MLLM readouts is future work.
