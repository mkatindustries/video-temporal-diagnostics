...
% Verified with TeX Live 2025 on 2026-07-27: seven PDF pages; references
...
nuScenes $0.916$ vs.\ $0.856$), yet loses over the full evaluation gallery (HDD $0.177$ vs.\
$0.256$; nuScenes $0.141$ vs.\ $0.315$). Separate pooled-pair controls do not support a general
...
(v1.0-trainval) yields $264$ segments from the $50$ largest mixed clusters, with $222$ eligible
queries drawn from $40$ clusters.
...
pooled unordered-pair AP protocol. All $95\%$ intervals use $2000$ intersection-cluster bootstrap
...
intersection, encoder-sequence DTW reaches mAP $0.955$ versus BoT's $0.923$ on HDD and $0.916$
versus $0.856$ on nuScenes (\cref{tab:reversal}, top). Paired gains exclude zero: $+0.032$
$[0.016, 0.042]$ and $+0.060$ $[0.028, 0.093]$, respectively.
...
10 draws. Intact encoder-sequence DTW exceeds this control detectably only on nuScenes ($+0.060$ AP,
$95\%$ CI $[0.023, 0.094]$); its HDD interval crosses zero ($[-0.001, 0.054]$), as do both residual
...
features ($+0.043$ $[0.017, 0.070]$). The nuScenes contrast is provisional because tiling sparse
...
\begin{table}[t]
  ...
  \begin{tabular}{llcc}
    ...
    & BoT (cosine)          & $0.923$ $[0.900, 0.948]$ & $0.856$ $[0.826, 0.896]$ \\
    & Encoder-seq DTW       & $0.955$ $[0.937, 0.971]$ & $0.916$ $[0.889, 0.948]$ \\
    & Temporal-residual DTW & $0.949$ $[0.931, 0.965]$ & $0.891$ $[0.861, 0.925]$ \\
    \midrule
    ...
    & Enc-seq DTW $-$ BoT (conditional) & $+0.032$ $[0.016, 0.042]$ & $+0.060$ $[0.028, 0.093]$ \\
